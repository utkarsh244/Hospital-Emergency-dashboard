...
🧠 DAX (Data Analysis Expressions)Calculated measures — Avg Wait Time, Satisfaction Score, No. of Patients, Referral counts
...
ii.What is the average patient wait time, and how does it vary by time of day or day of week?
iii.Which departments receive the most referrals, and are there patterns by demographics?
iv.What proportion of patients are being admitted vs. treated and released?
...
Slicers — Year and Month Name filters to drill into specific time windows
Area Charts (×4) — Daily trend lines for: No. of Patients · Avg Wait Time · Satisfaction Score · No. of Patients Referred
Patient Admission Status (Matrix) — Breakdown of admitted vs. not-admitted patients
Patients by Age Group (Bar Chart) — Distribution of patients across age bands
Patients by Department Referral (Bar Chart) — Which departments receive the most referrals
Wait Time Status (Clustered Bar) — Proportion of patients seen within vs. beyond target wait time
% Seen Within 30 Min (Donut Chart) — Quick visual on the 30-minute target compliance
Patients by Gender (Donut Chart) — Male / Female split
Patients by Race (Clustered Bar) — Racial composition of ER visits
...
📊 Healthcare Analysts           Track KPI trends over time and flag anomalies
